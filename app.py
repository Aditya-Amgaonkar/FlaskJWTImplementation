...
app.config['SECRET_KEY'] = 'bc2207a17a7bef157c00bd3c0cf39e14'
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite://///Users/adityaamgaonkar/PycharmProjects/FlaskJWTImplementation/bookstore.db'
...
def hello():
   return jsonify({'message': 'Application is working fine'})
...
def login_user():
   ...
   if check_password_hash(user.password, auth.password):
      token = jwt.encode(
         {'public_id': user.public_id, 'exp': datetime.datetime.utcnow() + datetime.timedelta(minutes=0.5)},
